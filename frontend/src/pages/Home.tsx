            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 xl:inline">tasks efficiently</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  A powerful task management system that helps you stay organized, track progress, and achieve your goals. 
                  Create, manage, and complete tasks with ease.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-gradient-to-r from-blue-400 to-indigo-500 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="text-white text-center">
              ...
              <p className="text-blue-100 mt-2">Made Simple</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides all the tools you need to stay organized and productive.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 lg:grid-cols-3">
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Task Creation</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Create detailed tasks with descriptions, due dates, and status tracking.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Due Date Tracking</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Never miss a deadline with our intelligent due date tracking and notifications.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Smart Filtering</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Filter tasks by status, due date, or priority to focus on what matters most.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Lightning-fast performance with a responsive design that works on any device.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-blue-600">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-blue-200">
            Join thousands of users who are already organizing their work and personal tasks efficiently.
          </p>
          {!user && (
            <Link
              to="/register"
      ...
      <footer className="bg-gray-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900">TaskManager</h3>
            <p className="mt-2 text-sm text-gray-500">
              © 2024 TaskManager. Built with React and Tailwind CSS.
            </p>
          </div>
        </div>
      </footer>
